...
const Welcome: React.FC = () => {
    return (
        <main className='relative w-full'>
            ...
            >
                <div className='flex flex-col max-[600px]:w-[200px] max-[600px]:mt-[90px] max-[600px]:p-[20px] max-[600px]:ml-[20px] max-[600px]:h-[175px] max-[600px]:gap-[8px] ml-[50px] gap-[35px] bg-[#fff] mt-[100px] items-start p-[44px] justify-center rounded-[16px] opacity-[0.9] w-[400px] max-[1300px]:w-[300px] max-[1300px]:h-[300px] h-[400px] shadow-xl max-[900px]:px-[30px] max-[900px]:py-[30px] max-[900px]:mt-[10px] max-[900px]:gap-[15px] max-[900px]:h-fit'>

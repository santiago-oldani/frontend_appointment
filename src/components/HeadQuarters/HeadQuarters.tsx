...
const sedesArray: Sedes[] = [
    ...
    },
    {
        ...
        subte: "No hay estación directa; cercanas: Línea H (Estación Facultad de Derecho) o Línea D (Estación Pueyrredón)."
    },
    {
        location: "Palermo",
        ...
        subte: "Línea D (Estación Palermo o Plaza Italia)."
    },
    {
        location: "Almagro",
        ...
        subte: "Línea B (Estación Medrano)."
    },
]

const HeadQuarters: React.FC = () => {
    return (
        <section className="bg-[#fff] h-auto w-full flex flex-col items-center justify-center">
            <div className="flex relative items-center justify-center py-[10px] w-full h-[40px] bg-[#0047ba]">
                <h1 className="text-[#fff] absolute left-[16%] text-[1.8rem]">Sedes</h1>
            </div>
            <div className="w-full flex flex-col items-center gap-y-[80px] justify-center py-[80px]">
                {sedesArray.map((sede) => {
                    return (

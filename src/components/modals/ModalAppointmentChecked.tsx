...
const ModalAppointmentChecked: React.FC<propsModal> = ({secondsToRedirect}) => {
    return (
        <>
            ...
            <div className="flex flex-col gap-[20px] max-[530px]:p-[15px] max-[530px]:w-auto justify-center items-center bg-[#fff] w-[90%] max-w-[400px] rounded-[14px] h-auto p-[30px] shadow-2xl relative">

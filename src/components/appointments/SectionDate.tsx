            ...
            {data.state === "blocked" ?
                <div className="w-full h-full flex flex-col items-center justify-center">
                    <div className="relative">
                        <FaRegCalendarTimes color="#a3a6ab" size={70} className="flex-shrink-0" />
                        <PiProhibitLight color="#a3a6ab" size={170} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex-shrink-0" />
                    </div>

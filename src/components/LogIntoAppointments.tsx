...
const LogIntoAppointments: React.FC = () => {
    ...
    return (
        <div className="min-h-[100vh] flex items-center justify-center bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] p-[35px] relative">
            ...
            <div
                onClick={() => { navigate('/') }}
                className="absolute top-[10%] left-[7%] flex items-center justify-center gap-[10px] text-[#fff] rounded-[14px] transition-all duration-[0.3s] hover:bg-[#fff] hover:text-[#000] px-[10px] py-[4px] cursor-pointer max-[400px]:text-[14px]">
                <IoMdArrowBack size={30} className="flex-shrink-0 max-[400px]:w-[20px] max-[400px]:h-[20px]" />
                Volver a la página principal
            </div>

            {/* La Card con el borde superior azul grueso y sombras específicas */}
            <div className="bg-[#ffffff] w-full max-w-[450px] max-[500px]:pl-[20px] rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] overflow-hidden border-t-[8px] border-[#0047ba] p-[40px]">
                ...
                <form
                    ...
                    <div className="flex flex-col gap-[8px]">
                        <label className="text-[#1e335f] text-[14px] font-[700] ml-[4px] max-[400px]:text-[12px]">DNI</label>
                        <input
                            id="dni"
                            ...
                            className="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none w-[90%] px-[20px] py-[16px] bg-[#f9fafb] border-[1px] border-[#e5e7eb] max-[400px]:px-[10px] max-[400px]:py-[12px] rounded-[16px] outline-none" />
                        {errors.dni && <span className="text-[#ff0000] text-[12px] ml-[5px]">{errors.dni}</span>}
                    </div>

                    {/* Input Nombre */}
                    <div className="flex flex-col gap-[8px]">
                        <label className="text-[#1e335f] text-[14px] font-[700] ml-[4px] max-[400px]:text-[12px]">Nombre</label>
                        <input
                            id="name"
                            onChange={handleChange}
                            value={formData.name}
                            ...
                            className="w-[90%] px-[20px] py-[16px] max-[400px]:px-[10px] max-[400px]:py-[12px] bg-[#f9fafb] border-[1px] border-[#e5e7eb] rounded-[16px] outline-none focus:border-[#0047ba] transition-all duration-[300ms]"
                        />
                    ...
                    {/* Input Apellido */}
                    <div className="flex flex-col gap-[8px]">
                        <label className="text-[#1e335f] text-[14px] font-[700] ml-[4px] max-[400px]:text-[12px]">Apellido</label>
                        <input
                            id="lastname"
                            onChange={handleChange}
                            ...
                            className="w-[90%] px-[20px] max-[400px]:px-[10px] max-[400px]:py-[12px] py-[16px] bg-[#f9fafb] border-[1px] border-[#e5e7eb] rounded-[16px] outline-none focus:border-[#0047ba] transition-all duration-[300ms]"
                        />
                    ...
                    <div className="flex items-center justify-center gap-[12px]">
                        ...
                        <button
                            type="submit"
                            className="w-[100%] bg-[#0047ba] text-[#ffffff] font-[700] text-[18px] max-[400px]:text-[14px] py-[16px] rounded-[16px] mt-[16px] cursor-pointer hover:bg-[#1e335f] transition-colors duration-[300ms] shadow-[0_10px_20px_rgba(0,71,186,0.2)] max-[400px]:py-[10px] border-none"
                        >
                            Acceder al Portal
                        </button>
                        ...
                        <button
                            ...
                            className="w-full bg-transparent cursor-pointer max-[400px]:text-[10px] border-[2px] border-[#0047ba] max-[400px]:py-[10px] text-[#0047ba] font-bold py-[14px] rounded-[16px] mt-[16px] hover:bg-[#f0f7ff] transition-all"
                        >
                ...
                <p className="text-center text-[#9ca3af] text-[12px] mt-[32px] max-[400px]:text-[10px]">
